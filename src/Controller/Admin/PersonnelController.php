...
class PersonnelController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager, EntrepriseRepository $entrepriseRep, UserPasswordHasherInterface $userPasswordHasher): Response
    {
        $user = new User();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $entityManager->flush();
            $this->addFlash("success","Personnel ajouté avec succèe");
    ...
    public function edit(Request $request, Personnel $personnel, EntityManagerInterface $entityManager, EntrepriseRepository $entrepriseRep, Hasher $hasher): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $entityManager->flush();
            $this->addFlash("success","Personnel modifié avec succèe");
            return $this->redirectToRoute('app_admin_personnel_index', [], Response::HTTP_SEE_OTHER);
        }
